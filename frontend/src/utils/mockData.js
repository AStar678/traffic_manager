    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="720" viewBox="0 0 1200 720">
      <defs>
        <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stop-color="#b9d9f4"/>
          <stop offset="55%" stop-color="#e8eef5"/>
          <stop offset="56%" stop-color="#667085"/>
          <stop offset="100%" stop-color="#1f2937"/>
        </linearGradient>
      </defs>
      <rect width="1200" height="720" fill="url(#sky)"/>
      <path d="M420 720 L550 380 H650 L820 720 Z" fill="#2f3947"/>
      <path d="M596 700 L600 610 M602 560 L604 500 M606 460 L608 420" stroke="#f8fafc" stroke-width="10" stroke-dasharray="38 28"/>
      <rect x="185" y="220" width="300" height="120" rx="18" fill="#334155"/>
      <rect x="700" y="250" width="280" height="115" rx="18" fill="#475569"/>
      <rect x="235" y="304" width="170" height="38" rx="6" fill="#dbeafe"/>
      <rect x="758" y="328" width="158" height="36" rx="6" fill="#dcfce7"/>
      <text x="32" y="48" font-family="Arial" font-size="26" font-weight="700" fill="#0f2744">RTSP live1 桥面道路前置摄像头</text>
    </svg>
  `),
  police: svgDataUrl(`
    <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="720" viewBox="0 0 1200 720">
      <rect width="1200" height="720" fill="#172033"/>
      <rect y="470" width="1200" height="250" fill="#263244"/>
      <g stroke="#f8fafc" stroke-width="18" opacity="0.85">
        <line x1="0" y1="565" x2="1200" y2="565"/>
        <line x1="0" y1="640" x2="1200" y2="640"/>
      </g>
      <circle cx="640" cy="130" r="48" fill="#facc15"/>
      <rect x="570" y="180" width="140" height="220" rx="60" fill="#2563eb"/>
      ...
      <rect x="590" y="390" width="42" height="210" rx="20" fill="#111827"/>
      <rect x="652" y="390" width="42" height="210" rx="20" fill="#111827"/>
      <text x="32" y="48" font-family="Arial" font-size="26" font-weight="700" fill="#e5e7eb">路口摄像头连续帧 · 交警手势识别</text>
    </svg>
  `),
  cockpit: svgDataUrl(`
    <svg xmlns="http://www.w3.org/2000/svg" width="1200" height="720" viewBox="0 0 1200 720">
      <rect width="1200" height="720" fill="#101828"/>
      <rect x="80" y="90" width="1040" height="520" rx="34" fill="#1f2937"/>
      <rect x="130" y="130" width="600" height="300" rx="20" fill="#0f172a"/>
      <rect x="780" y="150" width="270" height="80" rx="12" fill="#334155"/>
      <rect x="780" y="260" width="270" height="80" rx="12" fill="#334155"/>
      <rect x="780" y="370" width="270" height="80" rx="12" fill="#334155"/>
      <circle cx="430" cy="520" r="85" fill="none" stroke="#475569" stroke-width="28"/>
      <text x="32" y="48" font-family="Arial" font-size="26" font-weight="700" fill="#e5e7eb">车内摄像头 · 手势控车测试平台</text>
    </svg>
  `)
}
...
export const mockPoliceKeypoints = [
  ...
  { name: 'left_wrist', x: 460, y: 450, score: 0.9 },
  { name: 'right_wrist', x: 884, y: 260, score: 0.88 },
  { name: 'left_hip', x: 585, y: 500, score: 0.9 },
  { name: 'right_hip', x: 708, y: 502, score: 0.9 },
...
export const mockHandKeypoints = [
  ...
  { name: 'thumb_tip', x: 460, y: 500, score: 0.9 },
  ...
  { name: 'ring_tip', x: 760, y: 450, score: 0.9 },
  { name: 'pinky_mcp', x: 725, y: 630, score: 0.9 },
...
export const mockHistoryRecords = [
  {
    id: 1001,
    createdAt: '2026-07-08 09:18:32',
    taskType: 'license_plate',
    target: '京A12345 / 沪B8K21',
    status: 'completed',
    confidence: 0.96,
    duration: 418
  },
  {
    id: 1002,
    createdAt: '2026-07-08 09:21:08',
    taskType: 'police_gesture',
    target: '停止信号',
    status: 'completed',
    confidence: 0.93,
    duration: 612
  ...
  {
    id: 1003,
    createdAt: '2026-07-08 09:24:41',
    taskType: 'owner_gesture',
    target: '调节音量',
    status: 'completed',
    confidence: 0.91,
    duration: 238
...
export const businessPipelines = {
  image: ['选择图片', '上传 Java 后端', '生成 image_url', '调用算法 /inference/image', '写入历史记录', '前端渲染结果'],
  video: ['提交视频/RTSP', '创建 /jobs 异步任务', '算法抽帧推理', 'callback 回传 Java 后端', 'WebSocket 推送结果', '查询任务进度'],
  alert: ['写入 JSON 日志', 'Agent 监听异常', 'LLM 生成摘要', '保存告警事件', 'WebSocket/邮件通知']
}

export const mockAlerts = [
  {
    id: 'alert_20260708_001',
    severity: 'CRITICAL',
    title: '车牌识别连续失败',
    summary: '最近 1 分钟车牌识别失败率达到 34%，建议检查输入图片质量与算法服务状态。',
    module: 'license_plate',
    status: 'open',
    occurredAt: '2026-07-08 09:30:12',
    suggestedActions: ['检查上传图片清晰度', '确认算法服务 /health 正常', '查看失败请求日志']
  },
  {
    id: 'alert_20260708_002',
    severity: 'WARNING',
    title: '手势置信度持续偏低',
    summary: '车主手势模块近 5 分钟平均置信度为 0.48，可能存在光照不足或手部遮挡。',
  ...
  {
    id: 'alert_20260708_003',
    severity: 'INFO',
    title: 'WebSocket 已恢复连接',
...
export const mockVehicleState = {
  ...
  network: '5G',
  logStatus: '正常',
  climate: { temperature: 24, mode: 'Auto' },
...
export const mockSystemHealth = [
  { name: '模型服务', status: 'normal', value: '正常', detail: 'FastAPI /health OK' },
  { name: '后端服务', status: 'normal', value: '在线', detail: 'Spring Boot 8080' },
  { name: 'WebSocket', status: 'normal', value: '已连接', detail: '告警通道可用' },
  { name: '日志 Agent', status: 'warning', value: '观察中', detail: '低置信度规则触发 1 次' }
]
